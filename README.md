...
- **Multiple main windows** — open a new main window with <kbd>Ctrl</kbd>+<kbd>N</kbd> (<kbd>⌘N</kbd> on macOS) or the hamburger menu's *"New Main Window"* entry; the items/attachment context menu also gains a *"New Window"* action to open the selected items in a fresh main window.
