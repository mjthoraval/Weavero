...
export const PLUGIN_CSS = [
    ...
    // Per-row remove button (issue #9) — same minus-circle glyph as the
    // item pane's Related section; hidden until the row is hovered or it
    // has keyboard focus.
    ".wv-rel-remove {",
    ...
    "  visibility: hidden;",
    "}",
    ".wv-rel-remove .wv-rel-remove-icon {",
    "  display: block; width: 16px; height: 16px;",
    "  -moz-context-properties: fill, fill-opacity;",
    "  fill: currentColor;",
    "}",
    ".wv-rel-row:hover .wv-rel-remove,",
    ".wv-rel-remove:focus { visibility: visible; }",
    ".wv-rel-remove:hover { background-color: rgba(127, 127, 127, 0.25); }",
    ":root.wv-ui-dark .wv-rel-remove { color: var(--fill-secondary, #bdbdbd); }",
    ".wv-rel-icon {",
